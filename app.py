...
app.secret_key = os.getenv('SECRET_KEY', 'fallback-secret-key-for-development')  # Use env var, fallback for dev

# Ensure upload directory exists
os.makedirs(app.config['UPLOAD_FOLDER'], exist_ok=True)

# MongoDB connection
# Use MongoDB URI from environment variable, fallback to local if not set
